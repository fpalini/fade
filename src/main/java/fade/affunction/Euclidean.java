...
public class Euclidean extends AFFunctionEvaluatorByStatistic {
    public Euclidean(Configuration conf) {
        super(conf);
    }
    ...
    public AFValue evaluatePartialAFValue(Value s1, Value s2) {
        ...
        return new AFValue(Math.pow(count1 - count2, 2));
    }
    ...
    public AFValue finalizeAFValue(AFValue d) {
        return new AFValue(Math.sqrt(d.value));
    }
}
